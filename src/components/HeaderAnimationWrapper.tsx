      ...
      <div className="max-w-6xl lg:max-w-7xl xl:max-w-8xl mx-auto px-4 lg:px-5 xl:px-6">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <ScrollButton className="text-gray-600 hover:text-red-500 transition-colors font-medium text-sm lg:text-base">
              <TimelineContent
                as="span"
                animationNum={3}
                timelineRef={headerRef}
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Mobile Menu Button */}
            <MobileMenuButton headerRef={headerRef} animationNum={5} revealVariants={revealVariants} />
          </div>
        </div>
      </div>
    </header>
