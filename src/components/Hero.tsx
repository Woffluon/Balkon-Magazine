    ...
    <section className="py-8 px-4 lg:py-10 lg:px-5 xl:py-12 xl:px-6 bg-[#f9f9f9]" ref={heroRef}>
      <div className="max-w-6xl lg:max-w-7xl xl:max-w-8xl mx-auto lg:scale-105 xl:scale-105 transform-gpu">
        <div className="relative">
          ...
          >
            <>
              {/* Invisible SVG definition for clipPath */}
              ...
              {/* Responsive Container with Clip Path */}
              <div 
                className="w-full relative aspect-[100/40] overflow-hidden" 
                style={{ clipPath: 'url(#clip-inverted)', WebkitClipPath: 'url(#clip-inverted)' }}
              >
                <OptimizedImage
                  src="/hero_image.webp"
                  alt="Balkon Dergisi Kapak Görseli"
                  fill
                  priority
